...
const googleSignInUrl = import.meta.env.VITE_GOOGLE_SIGNIN_URL?.trim() ?? ''

const btnBase =
  'inline-flex w-full items-center justify-center gap-3 rounded-full min-h-[48px] px-6 py-3 text-[15px] font-semibold tracking-tight transition focus:outline-none focus-visible:ring-2 focus-visible:ring-[#00B4D8]/50 focus-visible:ring-offset-2 focus-visible:ring-offset-white/80'
    ...
    <div className="relative min-h-screen overflow-x-hidden" style={{ backgroundColor: '#FAFAFA' }}>
      ...
      <main className="relative z-10 mx-auto flex min-h-[calc(100dvh-5rem)] max-w-lg flex-col justify-center px-4 pb-16 pt-8 sm:px-6">
        <div
          ...
          style={{
            boxShadow:
              '0 25px 50px -12px rgba(15, 23, 42, 0.12), 0 0 0 1px rgba(255,255,255,0.5) inset',
          }}
        >
          <div className="mb-8 flex flex-col items-center text-center">
            ...
            />
            <h1
              className="text-2xl font-bold tracking-tight text-[#0F172A] sm:text-[1.65rem]"
              style={{ fontFamily: 'var(--font-display), Satoshi, system-ui, sans-serif' }}
            >
              Sign in to{' '}
              <span className="text-[#2776EA]">
                actionit<span className="text-[#00B4D8]">.ai</span>
              </span>
            </h1>
          </div>
          ...
          <p className="mt-8 text-center text-xs text-zinc-500">
            ...
            <Link to="/TOS" className="font-medium text-[#2776EA] underline-offset-2 hover:underline">
              Terms
            </Link>{' '}
            and{' '}
            <Link
              to="/privacy-policy"
              className="font-medium text-[#2776EA] underline-offset-2 hover:underline"
            >
              Privacy Policy
            </Link>
            .
          ...
          <div className="mt-6 text-center">
            <Link
              to="/"
              className="text-sm font-medium text-zinc-600 underline-offset-2 transition hover:text-[#00B4D8] hover:underline"
            >
              ← Back to home
            </Link>
          </div>
